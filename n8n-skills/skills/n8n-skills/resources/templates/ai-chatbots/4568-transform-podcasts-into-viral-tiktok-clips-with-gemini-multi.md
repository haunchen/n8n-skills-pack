...
### Triggers
- Send the YouTube Video Links (`n8n-nodes-base.formTrigger`)
...
- Podcast Best Moments Extraction (`@n8n/n8n-nodes-langchain.chainLlm`)
- Generate Title (`@n8n/n8n-nodes-langchain.chainLlm`)
...
|-----------|------|----------|
| Audio Transcription | `n8n-nodes-base.httpRequest` | Output |
| Google Gemini Chat Model | `@n8n/n8n-nodes-langchain.lmChatGoogleGemini` | AI |
| Split Out1 | `n8n-nodes-base.splitOut` | Other |
| Submit Job | `n8n-nodes-base.httpRequest` | Output |
| Check Status | `n8n-nodes-base.httpRequest` | Output |
| If | `n8n-nodes-base.if` | Transform |
| Extract Results | `n8n-nodes-base.set` | Transform |
| Wait1 | `n8n-nodes-base.wait` | Other |
| If1 | `n8n-nodes-base.if` | Transform |
| Google Gemini Chat Model1 | `@n8n/n8n-nodes-langchain.lmChatGoogleGemini` | AI |
| Structured Output Parser1 | `@n8n/n8n-nodes-langchain.outputParserStructured` | AI |
| Send the YouTube Video Links | `n8n-nodes-base.formTrigger` | Trigger |
| Transcribe Podcast Audio | `n8n-nodes-base.httpRequest` | Output |
| Wait 1 | `n8n-nodes-base.wait` | Other |
| Structure Transcription | `n8n-nodes-base.code` | Transform |
| Podcast Best Moments Extraction | `@n8n/n8n-nodes-langchain.chainLlm` | AI |
| Loop Over Clips | `n8n-nodes-base.splitInBatches` | Other |
| Structure Transcription 2 | `n8n-nodes-base.code` | Transform |
| Editing Clips | `n8n-nodes-base.httpRequest` | Output |
| Clip Ready? | `n8n-nodes-base.httpRequest` | Output |
| Structure Links | `n8n-nodes-base.set` | Transform |
| Generate Title | `@n8n/n8n-nodes-langchain.chainLlm` | AI |
| Download Final Clip | `n8n-nodes-base.httpRequest` | Output |
| Post To TikTok | `n8n-nodes-base.httpRequest` | Output |
| Posting Interval | `n8n-nodes-base.wait` | Other |
| Structured Output Parser | `@n8n/n8n-nodes-langchain.outputParserStructured` | AI |
| Download Audio Stage 1 | `n8n-nodes-base.httpRequest` | Output |
| Download Audio Stage 2 | `n8n-nodes-base.httpRequest` | Output |
| If4 | `n8n-nodes-base.if` | Transform |
| Wait3 | `n8n-nodes-base.wait` | Other |
| Download Audio Stage 3 | `n8n-nodes-base.httpRequest` | Output |
| Generating Main Clip | `n8n-nodes-base.httpRequest` | Output |
| If5 | `n8n-nodes-base.if` | Transform |
| Wait4 | `n8n-nodes-base.wait` | Other |
| Generating Background Clip | `n8n-nodes-base.httpRequest` | Output |
| Extracting Main Clip | `n8n-nodes-base.httpRequest` | Output |
| Extracting Background Clip | `n8n-nodes-base.httpRequest` | Output |
| If6 | `n8n-nodes-base.if` | Transform |
| Wait5 | `n8n-nodes-base.wait` | Other |
| Extracting Audio from Clips | `n8n-nodes-base.httpRequest` | Output |
| Extracting Audio from Main Clip 2 | `n8n-nodes-base.httpRequest` | Output |
| If7 | `n8n-nodes-base.if` | Transform |
| Wait6 | `n8n-nodes-base.wait` | Other |
| Download Clip Audio | `n8n-nodes-base.httpRequest` | Output |
| Clip Length Calculation | `n8n-nodes-base.code` | Transform |

## Connections

```
If --[main]--> Extract Results
If --[main]--> Wait 1
If1 --[main]--> Structure Links
If1 --[main]--> Wait1
If4 --[main]--> Download Audio Stage 3
If4 --[main]--> Wait3
If5 --[main]--> Clip Length Calculation
If5 --[main]--> Wait4
If6 --[main]--> Extracting Audio from Clips
If6 --[main]--> Wait5
If7 --[main]--> Download Clip Audio
If7 --[main]--> Wait6
Wait1 --[main]--> Clip Ready?
Wait3 --[main]--> Download Audio Stage 2
Wait4 --[main]--> Extracting Main Clip
Wait5 --[main]--> Extracting Background Clip
Wait6 --[main]--> Extracting Audio from Main Clip 2
Wait 1 --[main]--> Check Status
Split Out1 --[main]--> Loop Over Clips
Submit Job --[main]--> Wait 1
Clip Ready? --[main]--> If1
Check Status --[main]--> If
Editing Clips --[main]--> Wait1
Generate Title --[main]--> Download Final Clip
Post To TikTok --[main]--> Posting Interval
Extract Results --[main]--> Structure Transcription
Loop Over Clips --[main]--> Generating Main Clip
Structure Links --[main]--> Generate Title
Posting Interval --[main]--> Loop Over Clips
Audio Transcription --[main]--> Structure Transcription 2
Download Clip Audio --[main]--> Audio Transcription
Download Final Clip --[main]--> Post To TikTok
Extracting Main Clip --[main]--> If5
Generating Main Clip --[main]--> Extracting Main Clip
Download Audio Stage 1 --[main]--> Download Audio Stage 2
Download Audio Stage 2 --[main]--> If4
Download Audio Stage 3 --[main]--> Transcribe Podcast Audio
Clip Length Calculation --[main]--> Generating Background Clip
Structure Transcription --[main]--> Podcast Best Moments Extraction
Google Gemini Chat Model --[ai_languageModel]--> Podcast Best Moments Extraction
Structured Output Parser --[ai_outputParser]--> Podcast Best Moments Extraction
Transcribe Podcast Audio --[main]--> Submit Job
Google Gemini Chat Model1 --[ai_languageModel]--> Generate Title
Structure Transcription 2 --[main]--> Editing Clips
Structured Output Parser1 --[ai_outputParser]--> Generate Title
Extracting Background Clip --[main]--> If6
Generating Background Clip --[main]--> Extracting Background Clip
Extracting Audio from Clips --[main]--> Extracting Audio from Main Clip 2
Send the YouTube Video Links --[main]--> Download Audio Stage 1
Podcast Best Moments Extraction --[main]--> Split Out1
Extracting Audio from Main Clip 2 --[main]--> If7
```

## Workflow Summary

This workflow is triggered by Send the YouTube Video Links, uses Google Gemini Chat Model, Google Gemini Chat Model1, Structured Output Parser1, Podcast Best Moments Extraction, Generate Title, Structured Output Parser for AI processing, goes through 11 transformation step(s), finally outputs to Audio Transcription, Submit Job, Check Status, Transcribe Podcast Audio, Editing Clips, Clip Ready?, Download Final Clip, Post To TikTok, Download Audio Stage 1, Download Audio Stage 2, Download Audio Stage 3, Generating Main Clip, Generating Background Clip, Extracting Main Clip, Extracting Background Clip, Extracting Audio from Clips, Extracting Audio from Main Clip 2, Download Clip Audio.
## Author Information
- **Name**: Matt F.
- **Username**: @lemolex
- ✓ Verified user
## Related Links
- [View this template on n8n.io](https://n8n.io/workflows/4568)
...
```json
{
  ...
  "name": "🚀Transform Podcasts into Viral TikTok Clips with Gemini+ Multi-Platform Posting✅",
  "tags": [],
  "nodes": [
    {
  ...
  "versionId": "8f0c8648-71a6-4a05-b09b-3745209ca946",
  "connections": {
    "If": {
      "main": [
        [
