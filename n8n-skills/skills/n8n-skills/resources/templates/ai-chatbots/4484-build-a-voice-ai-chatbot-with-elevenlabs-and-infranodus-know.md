...
### AI Nodes
- OpenAI Model (`@n8n/n8n-nodes-langchain.lmChatOpenAi`)
...
|-----------|------|----------|
| OpenAI Model | `@n8n/n8n-nodes-langchain.lmChatOpenAi` | AI |
| Simple Memory | `@n8n/n8n-nodes-langchain.memoryBufferWindow` | AI |
| AI Agent | `@n8n/n8n-nodes-langchain.agent` | AI |
| Waves into Patterns Book Expert | `n8n-nodes-base.httpRequestTool` | Output |
| Special Agent's Manual Book Expert | `n8n-nodes-base.httpRequestTool` | Output |
| The Flow and the Notion Book | `n8n-nodes-base.httpRequestTool` | Output |
| The Polysingularity Letters Book | `n8n-nodes-base.httpRequestTool` | Output |
| Webhook | `n8n-nodes-base.webhook` | Trigger |
| Respond to Webhook | `n8n-nodes-base.respondToWebhook` | Trigger |
...
AI Agent --[main]--> Respond to Webhook
Simple Memory --[ai_memory]--> AI Agent
Google Gemini Chat Model --[ai_languageModel]--> AI Agent
The Flow and the Notion Book --[ai_tool]--> AI Agent
Waves into Patterns Book Expert --[ai_tool]--> AI Agent
The Polysingularity Letters Book --[ai_tool]--> AI Agent
Special Agent's Manual Book Expert --[ai_tool]--> AI Agent
```

## Workflow Summary

This workflow is triggered by Webhook, Respond to Webhook, uses OpenAI Model, Simple Memory, AI Agent, Google Gemini Chat Model for AI processing, finally outputs to Waves into Patterns Book Expert, Special Agent's Manual Book Expert, The Flow and the Notion Book, The Polysingularity Letters Book.
## Author Information
- **Name**: InfraNodus
- **Username**: @infranodus
- ✓ Verified user
