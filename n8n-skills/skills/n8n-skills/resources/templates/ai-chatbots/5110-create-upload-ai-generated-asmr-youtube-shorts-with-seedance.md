...
### AI Nodes
- Think (`@n8n/n8n-nodes-langchain.toolThink`)
- OpenAI Chat Model (`@n8n/n8n-nodes-langchain.lmChatOpenAi`)
- Prompts AI Agent (`@n8n/n8n-nodes-langchain.agent`)
- Parser (`@n8n/n8n-nodes-langchain.outputParserStructured`)
- Parser2 (`@n8n/n8n-nodes-langchain.outputParserStructured`)
- OpenAI Chat Model1 (`@n8n/n8n-nodes-langchain.lmChatOpenAi`)
- 1. Generate Trendy Idea (`@n8n/n8n-nodes-langchain.agent`)
- 2. Enrich Idea into Plan (`@n8n/n8n-nodes-langchain.agent`)

## All Nodes

| Node Name | Type | Category |
|-----------|------|----------|
| Unbundle Prompts | `n8n-nodes-base.code` | Transform |
| Create Sounds | `n8n-nodes-base.httpRequest` | Output |
| Get Sounds | `n8n-nodes-base.httpRequest` | Output |
| Wait for Sounds | `n8n-nodes-base.wait` | Other |
| List Elements | `n8n-nodes-base.code` | Transform |
| Sequence Video | `n8n-nodes-base.httpRequest` | Output |
| Get Final Video | `n8n-nodes-base.httpRequest` | Output |
| Wait for Final Video | `n8n-nodes-base.wait` | Other |
| Think | `@n8n/n8n-nodes-langchain.toolThink` | AI |
| OpenAI Chat Model | `@n8n/n8n-nodes-langchain.lmChatOpenAi` | AI |
| Prompts AI Agent | `@n8n/n8n-nodes-langchain.agent` | AI |
| Parser | `@n8n/n8n-nodes-langchain.outputParserStructured` | AI |
| Schedule Trigger | `n8n-nodes-base.scheduleTrigger` | Trigger |
| Parser2 | `@n8n/n8n-nodes-langchain.outputParserStructured` | AI |
| Create Clips | `n8n-nodes-base.httpRequest` | Output |
| Wait for Clips | `n8n-nodes-base.wait` | Other |
| Get Clips | `n8n-nodes-base.httpRequest` | Output |
| Download Final Video | `n8n-nodes-base.httpRequest` | Output |
| Upload to YouTube | `n8n-nodes-base.youTube` | Other |
| Telegram Notification | `n8n-nodes-base.telegram` | Output |
| OpenAI Chat Model1 | `@n8n/n8n-nodes-langchain.lmChatOpenAi` | AI |
| Gmail Notification | `n8n-nodes-base.gmail` | Output |
| 1. Generate Trendy Idea | `@n8n/n8n-nodes-langchain.agent` | AI |
| 2. Enrich Idea into Plan | `@n8n/n8n-nodes-langchain.agent` | AI |
| 3. Log New Idea to Sheet | `n8n-nodes-base.googleSheets` | Input |
| Update Final Video to Sheet | `n8n-nodes-base.googleSheets` | Input |
| Update Sheet with Youtube Link | `n8n-nodes-base.googleSheets` | Input |

## Connections

```
Think --[ai_tool]--> 2. Enrich Idea into Plan
Think --[ai_tool]--> Prompts AI Agent
Parser --[ai_outputParser]--> 2. Enrich Idea into Plan
Parser2 --[ai_outputParser]--> Prompts AI Agent
Get Clips --[main]--> Create Sounds
Get Sounds --[main]--> List Elements
Create Clips --[main]--> Wait for Clips
Create Sounds --[main]--> Wait for Sounds
List Elements --[main]--> Sequence Video
Sequence Video --[main]--> Wait for Final Video
Wait for Clips --[main]--> Get Clips
Get Final Video --[main]--> Update Final Video to Sheet
Wait for Sounds --[main]--> Get Sounds
Prompts AI Agent --[main]--> Unbundle Prompts
Schedule Trigger --[main]--> 1. Generate Trendy Idea
Unbundle Prompts --[main]--> Create Clips
OpenAI Chat Model --[ai_languageModel]--> 2. Enrich Idea into Plan
OpenAI Chat Model --[ai_languageModel]--> Prompts AI Agent
Upload to YouTube --[main]--> Gmail Notification
Upload to YouTube --[main]--> Telegram Notification
Upload to YouTube --[main]--> Update Sheet with Youtube Link
OpenAI Chat Model1 --[ai_languageModel]--> 1. Generate Trendy Idea
Download Final Video --[main]--> Upload to YouTube
Wait for Final Video --[main]--> Get Final Video
1. Generate Trendy Idea --[main]--> 2. Enrich Idea into Plan
2. Enrich Idea into Plan --[main]--> 3. Log New Idea to Sheet
3. Log New Idea to Sheet --[main]--> Prompts AI Agent
Update Final Video to Sheet --[main]--> Download Final Video
```

## Workflow Summary

This workflow is triggered by Schedule Trigger, uses Think, OpenAI Chat Model, Prompts AI Agent, Parser, Parser2, OpenAI Chat Model1, 1. Generate Trendy Idea, 2. Enrich Idea into Plan for AI processing, goes through 2 transformation step(s), finally outputs to Create Sounds, Get Sounds, Sequence Video, Get Final Video, Create Clips, Get Clips, Download Final Video, Telegram Notification, Gmail Notification.
## Author Information
- **Name**: Bilel Aroua
