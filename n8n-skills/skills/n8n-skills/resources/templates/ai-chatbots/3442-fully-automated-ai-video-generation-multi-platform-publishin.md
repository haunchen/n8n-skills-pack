...
### Triggers
- Once Per Day (`n8n-nodes-base.scheduleTrigger`)

### AI Nodes
- Generate Image Prompts (`@n8n/n8n-nodes-langchain.openAi`)
- Generate Video Captions (`@n8n/n8n-nodes-langchain.openAi`)
- Generate Script (`@n8n/n8n-nodes-langchain.openAi`)
- Get Audio from Video (`@n8n/n8n-nodes-langchain.openAi`)
- Generate Description for Videos  in Tiktok and Instagram (`@n8n/n8n-nodes-langchain.openAi`)

## All Nodes

| Node Name | Type | Category |
|-----------|------|----------|
| Get image | `n8n-nodes-base.httpRequest` | Output |
| Generate Image | `n8n-nodes-base.httpRequest` | Output |
| Image-to-Video | `n8n-nodes-base.httpRequest` | Output |
| Get Video | `n8n-nodes-base.httpRequest` | Output |
| List Elements | `n8n-nodes-base.code` | Transform |
| Wait 10min | `n8n-nodes-base.wait` | Other |
| Wait 3min | `n8n-nodes-base.wait` | Other |
| Wait 5min | `n8n-nodes-base.wait` | Other |
| Generate voice | `n8n-nodes-base.httpRequest` | Output |
| List Elements1 | `n8n-nodes-base.code` | Transform |
| Fail check | `n8n-nodes-base.if` | Transform |
| Wait to retry | `n8n-nodes-base.wait` | Other |
| Generate Image Prompts | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Calculate Token Usage | `n8n-nodes-base.code` | Transform |
| Check for failures | `n8n-nodes-base.if` | Transform |
| Generate Video Captions | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Match captions with videos | `n8n-nodes-base.merge` | Transform |
| Generate Script | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Upload Voice Audio | `n8n-nodes-base.googleDrive` | Input |
| Set Access Permissions | `n8n-nodes-base.googleDrive` | Input |
| Pair Videos with Audio | `n8n-nodes-base.merge` | Transform |
| Render Final Video | `n8n-nodes-base.httpRequest` | Output |
| Notify me on Discord | `n8n-nodes-base.discord` | Output |
| Once Per Day | `n8n-nodes-base.scheduleTrigger` | Trigger |
| Load Google Sheet | `n8n-nodes-base.googleSheets` | Input |
| Create List | `n8n-nodes-base.code` | Transform |
| Wait1 | `n8n-nodes-base.wait` | Other |
| Get Final Video | `n8n-nodes-base.httpRequest` | Output |
| Upload Final Video | `n8n-nodes-base.googleDrive` | Input |
| Get Raw File | `n8n-nodes-base.httpRequest` | Output |
| Set Permissions | `n8n-nodes-base.googleDrive` | Input |
| Update Google Sheet | `n8n-nodes-base.googleSheets` | Input |
| Set API Keys | `n8n-nodes-base.set` | Transform |
| Validate list formatting | `n8n-nodes-base.if` | Transform |
| Get Audio from Video | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Generate Description for Videos  in Tiktok and Instagram | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Upload Video and Description to Tiktok | `n8n-nodes-base.httpRequest` | Output |
| Upload Video and Description to Instagram | `n8n-nodes-base.httpRequest` | Output |
| Upload Video and Description to Youtube | `n8n-nodes-base.httpRequest` | Output |
| Upload Video and Description to Facebook | `n8n-nodes-base.httpRequest` | Output |
| Upload Video and Description to Linkedin | `n8n-nodes-base.httpRequest` | Output |
| Read Video from Google Drive | `n8n-nodes-base.readBinaryFile` | Other |
| Write video | `n8n-nodes-base.writeBinaryFile` | Other |

## Connections

```
Wait1 --[main]--> Get Final Video
Get Video --[main]--> Fail check
Get image --[main]--> Check for failures
Wait 3min --[main]--> Get image
Wait 5min --[main]--> Generate Image
Fail check --[main]--> Wait to retry
Fail check --[main]--> Match captions with videos
Wait 10min --[main]--> Get Video
Create List --[main]--> Validate list formatting
Write video --[main]--> Get Audio from Video
Get Raw File --[main]--> Upload Final Video
Get Raw File --[main]--> Write video
Once Per Day --[main]--> Set API Keys
Set API Keys --[main]--> Load Google Sheet
List Elements --[main]--> Pair Videos with Audio
Wait to retry --[main]--> Image-to-Video
Generate Image --[main]--> Wait 3min
Generate voice --[main]--> Upload Voice Audio
Image-to-Video --[main]--> Wait 10min
List Elements1 --[main]--> Pair Videos with Audio
Generate Script --[main]--> Generate voice
Get Final Video --[main]--> Get Raw File
Set Permissions --[main]--> Update Google Sheet
Load Google Sheet --[main]--> Generate Video Captions
Check for failures --[main]--> Wait 5min
Check for failures --[main]--> Image-to-Video
Render Final Video --[main]--> Wait1
Upload Final Video --[main]--> Set Permissions
Upload Voice Audio --[main]--> Set Access Permissions
Update Google Sheet --[main]--> Notify me on Discord
Get Audio from Video --[main]--> Generate Description for Videos  in Tiktok and Instagram
Calculate Token Usage --[main]--> Generate Image
Generate Image Prompts --[main]--> Calculate Token Usage
Pair Videos with Audio --[main]--> Render Final Video
Set Access Permissions --[main]--> List Elements1
Generate Video Captions --[main]--> Create List
Validate list formatting --[main]--> Generate Image Prompts
Validate list formatting --[main]--> Match captions with videos
Validate list formatting --[main]--> Generate Script
Validate list formatting --[main]--> Generate Video Captions
Match captions with videos --[main]--> List Elements
Read Video from Google Drive --[main]--> Upload Video and Description to Tiktok
Read Video from Google Drive --[main]--> Upload Video and Description to Instagram
Read Video from Google Drive --[main]--> Upload Video and Description to Youtube
Read Video from Google Drive --[main]--> Upload Video and Description to Facebook
Read Video from Google Drive --[main]--> Upload Video and Description to Linkedin
Generate Description for Videos  in Tiktok and Instagram --[main]--> Read Video from Google Drive
```

## Workflow Summary

This workflow is triggered by Once Per Day, uses Generate Image Prompts, Generate Video Captions, Generate Script, Get Audio from Video, Generate Description for Videos  in Tiktok and Instagram for AI processing, goes through 10 transformation step(s), finally outputs to Get image, Generate Image, Image-to-Video, Get Video, Generate voice, Render Final Video, Notify me on Discord, Get Final Video, Get Raw File, Upload Video and Description to Tiktok, Upload Video and Description to Instagram, Upload Video and Description to Youtube, Upload Video and Description to Facebook, Upload Video and Description to Linkedin.
## Author Information
- **Name**: Juan Carlos Cavero Gracia
- **Username**: @carlosgracia
- ✓ Verified user
## Related Links
- [View this template on n8n.io](https://n8n.io/workflows/3442)
