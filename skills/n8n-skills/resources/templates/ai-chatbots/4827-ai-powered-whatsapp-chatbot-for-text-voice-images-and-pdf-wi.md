...
### AI Nodes
- Knowledge Base Agent (`@n8n/n8n-nodes-langchain.agent`)
...
- MongoDB Vector Search (`@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas`)
- Document Section Loader (`@n8n/n8n-nodes-langchain.documentDefaultDataLoader`)
- Document Chunker (`@n8n/n8n-nodes-langchain.textSplitterRecursiveCharacterTextSplitter`)
- MongoDB Vector Store Inserter (`@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas`)
- OpenAI Embeddings Generator (`@n8n/n8n-nodes-langchain.embeddingsOpenAi`)
- OpenAI (`@n8n/n8n-nodes-langchain.openAi`)
- OpenAI1 (`@n8n/n8n-nodes-langchain.openAi`)

## All Nodes

| Node Name | Type | Category |
|-----------|------|----------|
| Knowledge Base Agent | `@n8n/n8n-nodes-langchain.agent` | AI |
...
| MongoDB Vector Search | `@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas` | AI |
| Document Section Loader | `@n8n/n8n-nodes-langchain.documentDefaultDataLoader` | AI |
| Document Chunker | `@n8n/n8n-nodes-langchain.textSplitterRecursiveCharacterTextSplitter` | AI |
| MongoDB Vector Store Inserter | `@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas` | AI |
| OpenAI Embeddings Generator | `@n8n/n8n-nodes-langchain.embeddingsOpenAi` | AI |
| Google Docs Importer | `n8n-nodes-base.googleDocs` | Other |
| WhatsApp Trigger | `n8n-nodes-base.whatsAppTrigger` | Trigger |
| OpenAI | `@n8n/n8n-nodes-langchain.openAi` | AI |
| OpenAI1 | `@n8n/n8n-nodes-langchain.openAi` | AI |
| Extract from PDF | `n8n-nodes-base.extractFromFile` | Other |
| Extract from XLS | `n8n-nodes-base.extractFromFile` | Other |
| Extract from XLSX | `n8n-nodes-base.extractFromFile` | Other |
| Map JSON | `n8n-nodes-base.set` | Transform |
| Map file extensions | `n8n-nodes-base.code` | Transform |
| Map document prompt | `n8n-nodes-base.set` | Transform |
| Map image prompt | `n8n-nodes-base.set` | Transform |
| Map text prompt | `n8n-nodes-base.set` | Transform |
| Gets WhatsApp Voicemail Source URL | `n8n-nodes-base.whatsApp` | Other |
| Gets WhatsApp Image Source URL | `n8n-nodes-base.whatsApp` | Other |
| Gets WhatsApp Document Source URL | `n8n-nodes-base.whatsApp` | Other |
| Download Voicemail | `n8n-nodes-base.httpRequest` | Output |
| Download Image | `n8n-nodes-base.httpRequest` | Output |
| Download Document | `n8n-nodes-base.httpRequest` | Output |
| Route Types | `n8n-nodes-base.switch` | Transform |
| Route Document Types | `n8n-nodes-base.switch` | Transform |
| Send Unsupported Response | `n8n-nodes-base.whatsApp` | Other |
| Send Response | `n8n-nodes-base.whatsApp` | Other |

## Connections

```
OpenAI --[main]--> Knowledge Base Agent
OpenAI1 --[main]--> Map image prompt
Map JSON --[main]--> Map document prompt
Route Types --[main]--> Map text prompt
Route Types --[main]--> Gets WhatsApp Voicemail Source URL
Route Types --[main]--> Gets WhatsApp Image Source URL
Route Types --[main]--> Gets WhatsApp Document Source URL
Simple Memory --[ai_memory]--> Knowledge Base Agent
Download Image --[main]--> OpenAI1
Map text prompt --[main]--> Knowledge Base Agent
Document Chunker --[ai_textSplitter]--> Document Section Loader
Extract from PDF --[main]--> Map document prompt
Extract from XLS --[main]--> Map JSON
Map image prompt --[main]--> Knowledge Base Agent
WhatsApp Trigger --[main]--> Route Types
Download Document --[main]--> Map file extensions
Embeddings OpenAI --[ai_embedding]--> MongoDB Vector Search
Extract from XLSX --[main]--> Map JSON
OpenAI Chat Model --[ai_languageModel]--> Knowledge Base Agent
Download Voicemail --[main]--> OpenAI
Map document prompt --[main]--> Knowledge Base Agent
Map file extensions --[main]--> Route Document Types
Google Docs Importer --[main]--> MongoDB Vector Store Inserter
Knowledge Base Agent --[main]--> Send Response
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Map document prompt
Route Document Types --[main]--> Extract from PDF
Route Document Types --[main]--> Map JSON
Route Document Types --[main]--> Extract from XLS
Route Document Types --[main]--> Extract from XLSX
Route Document Types --[main]--> Send Unsupported Response
MongoDB Vector Search --[ai_tool]--> Knowledge Base Agent
Document Section Loader --[ai_document]--> MongoDB Vector Store Inserter
OpenAI Embeddings Generator --[ai_embedding]--> MongoDB Vector Store Inserter
Gets WhatsApp Image Source URL --[main]--> Download Image
When clicking "Execute Workflow" --[main]--> Google Docs Importer
Gets WhatsApp Document Source URL --[main]--> Download Document
Gets WhatsApp Voicemail Source URL --[main]--> Download Voicemail
```

## Workflow Summary

This workflow is triggered by When clicking "Execute Workflow", WhatsApp Trigger, uses Knowledge Base Agent, OpenAI Chat Model, Embeddings OpenAI, Simple Memory, MongoDB Vector Search, Document Section Loader, Document Chunker, MongoDB Vector Store Inserter, OpenAI Embeddings Generator, OpenAI, OpenAI1 for AI processing, goes through 7 transformation step(s), finally outputs to Download Voicemail, Download Image, Download Document.
## Author Information
- **Name**: NovaNode
- **Username**: @thomasgpt
- ✓ Verified user
## Related Links
- [View this template on n8n.io](https://n8n.io/workflows/4827)
