...
|-----------|------|----------|
| Gmail Trigger | `n8n-nodes-base.gmailTrigger` | Trigger |
| Gmail | `n8n-nodes-base.gmail` | Output |
| Structured Output Parser | `@n8n/n8n-nodes-langchain.outputParserStructured` | AI |
| Gmail1 | `n8n-nodes-base.gmail` | Output |
...
| Check Sent | `n8n-nodes-base.gmailTool` | Output |

## Connections

```
Gmail --[main]--> AI Agent
AI Agent --[main]--> Gmail1
Get Email --[ai_tool]--> AI Agent
Check Sent --[ai_tool]--> AI Agent
Gmail Trigger --[main]--> Gmail
...
This workflow is triggered by Gmail Trigger, uses Structured Output Parser, Anthropic Chat Model, AI Agent for AI processing, finally outputs to Gmail, Gmail1, Get Email, Check Sent.
## Author Information
- **Name**: Max Mitcham
- **Username**: @maxmitcham
- ✓ Verified user
